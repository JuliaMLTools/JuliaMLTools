...
const example1 = `include("imports.jl")
            ...
            <Grid container spacing={2} style={{marginTop:20}}>
                ...
                <Grid xs={8}>
                    <Typography variant="h4" component="h1" gutterBottom>
                        Example: ShakespeareGPT
                    </Typography>
                    
                    <Typography color="text.secondary">
                        TAGS  <Chip label="TransformerBlocks.jl" variant="outlined" />
                    </Typography>
                    ...
                    Julia implementation of Andrej Karpathy's excellent <Link href="https://youtu.be/kCc8FmEb1nY">Let's build GPT: from scratch, in code, spelled out</Link>.
                    </Typography>

                    <iframe width="100%" height="400" src="https://www.youtube.com/embed/kCc8FmEb1nY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
